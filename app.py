...
<div id="dash">
  ...
  <div class="wrap">
    ...
    <div class="card" id="emailcard" style="margin-top:22px">
      ...
      <textarea id="emailbox" rows="3" placeholder="hong@unitron.com, kim@unitron.com, ..." style="width:100%;font-size:14px;padding:12px 14px;border:1.5px solid var(--line);border-radius:11px;font-family:inherit;outline:none;resize:vertical"></textarea>
      <div style="margin-top:14px;display:flex;gap:12px;align-items:center;flex-wrap:wrap">
...
function buildEmailCard(){
  ...
  document.getElementById('emailbox').value = localStorage.getItem('emails_'+O.name)||'';
